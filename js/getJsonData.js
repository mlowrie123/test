...
$(document).ready(function(){
	 ...
	 $.getJSON('./application/model/data.json', function(jsonObj) {
		console.log(jsonObj); // used to help debug
		...
		// $('#x3dModelTitle_zero').html('<h2>' + jsonObj.pageTextData[6].x3dModelTitle + '<h2>');
		// $('#x3dCreationMethod_zero').html('<p>' + jsonObj.pageTextData[6].x3dCreationMethod + '<p>');
 		// $('#title_zero').html('<h2>' + jsonObj.pageTextData[6].title + '<h2>');
		// $('#subTitle_zero').html('<h3>' + jsonObj.pageTextData[6].subTitle + '</h3>');
		// $('#description_zero').html('<p>' + jsonObj.pageTextData[6].description + '</p>');

        // //Get the pepper main text data
		// $('#x3dModelTitle_zero2').html('<h2>' + jsonObj.pageTextData[7].x3dModelTitle + '<h2>');
		// $('#x3dCreationMethod_zero2').html('<p>' + jsonObj.pageTextData[7].x3dCreationMethod + '<p>');

	...
	xmlHttp.onreadystatechange = function() {
		if(xmlHttp.readyState == 4) {
			...
			for (var i=0;i<response.length;i++) {
				...
				htmlCode += '<a href="'+ response[i] + ' "data-fancybox data-caption="Rendered photo of my model from Cinema 4D">';
				htmlCode += '<img class="card-img-top img-thumbnail gallery" src="' + response[i] + '"/>';
				htmlCode += '</a>';			
			}
			...
			document.getElementById('gallery_pepsi_move').innerHTML = htmlCode;
		}
	}
});
